...
- [ ] Optimize NV12 decoder — `types.rs` lines 1590-1664 repeat UV plane index division per pixel. Pre-compute row offsets and use direct indexing. Also consider inlining `yuyv444_to_rgb` calls (same pattern as YUYV optimization).
